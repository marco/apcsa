...
public class MazeBuilderTest {
	...
	@Test
	public void generateMazesSolvable() {
		for (int i = 0; i < 100; i++) {
			Maze maze = SimpleMazeBuilder.getRandomSolvableMaze(100, 0.5);
			assertTrue(new SimpleMazeSolver(maze).getIsSolvable());
		}
	}

	@Test
	public void generateMazesUnsolvable() {
		for (int i = 0; i < 10; i++) {
			Maze maze = SimpleMazeBuilder.getRandomUnsolvableMaze(100, 0.5);
			assertFalse(new SimpleMazeSolver(maze).getIsSolvable());
		}
	}
}
