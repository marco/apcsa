...
public class Connect4Frame extends JFrame {
   ...
   */
  private JButton newGameButton, nextMoveButton, playToEndButton, newPlayToEndButton;
  /**
  ...
  public Connect4Frame(Connect4Game game, Agent redPlayer, Agent yellowPlayer) {
    ...
    newPlayToEndButton = new JButton("New Play to End");   // creates the button for finishing the game
    newPlayToEndButton.setAlignmentX(Component.CENTER_ALIGNMENT);  // centers the button
    // connects the new play to end button to its buttonPressed method
    newPlayToEndButton.addActionListener(new ActionListener() {
      public void actionPerformed(ActionEvent e) {
        newGameButtonPressed();
        playToEndButtonPressed();
      }
    ...
    buttonPane.add(Box.createRigidArea(new Dimension(10, 0)));
    buttonPane.add(newPlayToEndButton);
    buttonPane.add(Box.createHorizontalGlue());
