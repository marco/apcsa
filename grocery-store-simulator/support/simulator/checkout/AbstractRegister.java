...
public abstract class AbstractRegister {
    /**
     * The transactions that have been done by this register.
     */
  private final List<Transaction> transactions = new LinkedList<Transaction>();

    /**
     * The ending time for the current transaction.
     */
  private int transactionEndTime;

    /**
     * The total cost to run this register.
     */
  private double runningCost = 0;

    /**
     * Whether or not this register is running.
     */
  ...
  public final Transaction processShopper(final Shopper s) {
      final int DIFFICULTY_MULTIPLIER = 5000;
  ...
  public final double getRunningCost() {
    ...
    /**
     * Returns whether or not this is running.
     *
  ...
  public final void tick() {
      final double RUNNING_COST_CHANGE = 0.15;

    if (running) {
      runningCost += RUNNING_COST_CHANGE;
    }
  }
