...
public class PlusOperatorTest {
  ...
  public void testPerformOperation() {
    ...
    public void testPerformOperationNegative() {
        operator.setOperand(0, new Operand<Integer>(-9));
        operator.setOperand(1, new Operand<Integer>(8));

        Operand<Integer> result = operator.performOperation();
        int value = result.getValue();
        assertEquals("Operator applied to -9 and 8 should produce -1.", -1,
                value);
    }
    ...
    public void testPerformOperationTwoNegatives() {
        ...
        Operand<Integer> result = operator.performOperation();
        int value = result.getValue();
        assertEquals("Operator applied to -9 and -8 should produce -17.", -17,
                value);
    }
