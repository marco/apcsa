 ...
 *
 */
public class ArithInfixParser implements PostFixParser<Integer> {
    ...
    static {
        operators = new HashMap<String, ArithInfixParser.OperatorConstructor>();

        Operator[] operatorsToInclude = {
            new PlusOperator(),
            new MultOperator(),
            new SubOperator(),
            new DivOperator(),
            ...
            new SqrtOperator(),
            new StartParenthesisOperator(),
            new EndParenthesisOperator(),
        };

        for (int i = 0; i < operatorsToInclude.length; i++) {
            Operator currentOperator = operatorsToInclude[i];

            operators.put(currentOperator.getStringRepresentation(), new OperatorConstructor() {
                @Override
                public Operator<Integer> construct() {
        ...
        operators.put("q", new OperatorConstructor() {
            @Override
            public Operator<Integer> construct() {
        ...
        operators.put("(", new OperatorConstructor() {
            @Override
            public Operator<Integer> construct() {
                return new StartParenthesisOperator();
            }
        });
        ...
        operators.put(")", new OperatorConstructor() {
            @Override
            public Operator<Integer> construct() {
                return new EndParenthesisOperator();
            }
        });
    }
    ...
    /**
     * Creates an {@link ArithInfixParser} over {@code expr}.
     *
