 ...
 *
 */
public class ArithPrefixParser implements PostFixParser<Integer> {
    ...
    static {
        operators = new HashMap<String, ArithPrefixParser.OperatorConstructor>();
    ...
    /**
     * Creates an {@link ArithPrefixParser} over {@code expr}.
     *
     ...
     * expression.
     */
    public ArithPrefixParser(String expr) {
        if (expr == null) {
